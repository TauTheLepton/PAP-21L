...
import com.headempty.xd365calendar.web.rest.errors.CustomParameterizedException;
import java.net.URI;
...
/**
 * REST controller for managing {@link com.headempty.xd365calendar.domain.Event}.
 */
@RestController
@RequestMapping("/api")
@Transactional
